...
public final class MRClientForgeEvents
{
	...
	public static void onConstructTooltip(ItemTooltipEvent event)
	{
		...
		event.getToolTip().add(new TranslationTextComponent("tooltip.mendingrework.repair_bonus", ItemStack.DECIMALFORMAT.format(MRUtilities.getRepairBonus(stack) * 100d)).applyTextStyle(TextFormatting.DARK_AQUA));
	}
}